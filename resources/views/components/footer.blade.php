<footer class="bg-gray-900 text-white pt-16 pb-6">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                <!-- Column 1 -->
                <div>
                    <a href="#" class="text-3xl font-['Pacifico'] text-white mb-6 inline-block">Merylowers</a>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="/Shop" class="text-gray-400 hover:text-white transition">Boutique</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-400">123 Rue des Fleurs, 6200 nador, maroc</span>
                        </li>
            ...
            <div class="border-t border-gray-800 pt-8 pb-4">
                <div class="flex flex-wrap justify-between items-center">
                    <div class="mb-4 md:mb-0">
                        <p class="text-gray-500">© 2025 Merylowers. Tous droits réservés.</p>
                    </div>
